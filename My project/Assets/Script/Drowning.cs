...
public class Drowning : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (Sim)
        {
            ...
            Boat.GetComponent<Rigidbody>().AddTorque(torque: UnityEngine.Quaternion.ToEulerAngles(UnityEngine.Quaternion.Euler((float)(BoatG[4] * 180 / Math.PI), (float)(BoatG[5] * 180 / Math.PI), (float)(BoatG[3] * 180 / Math.PI))) - UnityEngine.Quaternion.ToEulerAngles(gameObject.transform.rotation), mode: ForceMode.VelocityChange);
        }
